...
The source of icons is https://icons8.de/icons/set/android
 ...
 For using this app, you need Google Map Places API Keys. First, you need an account of Google Cloud Platform and create a praject. Then, you need to activate the API "Places API". And then, you can use your API key in the project.
